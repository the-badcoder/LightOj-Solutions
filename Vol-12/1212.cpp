...
int main()
{
    int test, n, m, sum, digit, add, store, loop = 0;
    deque <int> in, out;
    string s, s1;
    ...
    while( test-- )
    {
        ...
        while( m-- )
        {
            ...
            {
                cin >> add;
                if( in.empty() || n != in.size() )
                {
                    in.push_back(add);
                    //store = in.back();
                    cout << "Pushed in left: " << add << endl;
                }
                else
                {
            ...
            if( s == "popRight" )
            {
                if( !in.empty() )
                {
                    store = in.front();
                    in.pop_front();
                    cout << "Popped from right: " << store << endl;
                }
                else
                {
            ...
            if( s == "popLeft" )
            {
                if( !in.empty() )
                {
                    store = in.back();
                    in.pop_back();
                    cout << "Popped from left: " << store << endl;
                }
                else
                {
                    cout << "The queue is empty\n";
